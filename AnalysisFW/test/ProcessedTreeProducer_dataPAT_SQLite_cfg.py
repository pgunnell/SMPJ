...
process.jec = cms.ESSource("PoolDBESSource",
      ...
      cms.PSet(
            record = cms.string('JetCorrectionsRecord'),
            tag    = cms.string('JetCorrectorParametersCollection_Winter14_V5_DATA_AK7PF'),
            # tag    = cms.string('JetCorrectorParametersCollection_Summer12_V7_MC_AK7PF'),
      ...
      cms.PSet(
            record = cms.string('JetCorrectionsRecord'),
            tag    = cms.string('JetCorrectorParametersCollection_Winter14_V5_DATA_AK7Calo'),
...
process.ak7 = cms.EDAnalyzer('ProcessedTreeProducer',
    ...
    jecUncSrc       = cms.string('Winter14_V5_DATA_UncertaintySources_AK7PF.txt'),
    jecUncSrcCHS    = cms.string('Winter14_V5_DATA_UncertaintySources_AK7PFchs.txt'), 
    jecUncSrcNames  = cms.vstring('AbsoluteStat','AbsoluteScale','AbsoluteFlavMap','AbsoluteMPFBias','HighPtExtra','SinglePionECAL',
                                  ...
                                  'SubTotalPileUp','SubTotalRelative','SubTotalPt','SubTotalScale','SubTotalMC','Total','TotalNoFlavor',
...
process.ak5 = process.ak7.clone(
    ...
    jecUncSrc       = cms.string('Winter14_V5_DATA_UncertaintySources_AK5PF.txt'),
    jecUncSrcCHS    = cms.string('Winter14_V5_DATA_UncertaintySources_AK5PFchs.txt'),
