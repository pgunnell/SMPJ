...
class MyElectron
{
   public:
     ...
     //New Instructions
     void setElectronDxyVertex(double fDxyVertex)    {DxyVertex_ = fDxyVertex;}
     void setElectronDzVertex(double fDzVertex)    {DzVertex_ = fDzVertex;}
     void setPDGId(double fPDGID) {PDGID_ = fPDGID;}
     void setPfIso(double fPfIso) {PfIso_ = fPfIso;}

     void setChargedHadronIos(double fChargedHadronIso) {fChargedHadronIso = ChargedHadronIso_;}
     ...
     float ElectronDZVertex()          const {return DzVertex_;}
     float ElectronDxyVertex()          const {return DxyVertex_;}
